    ...
    public class ZIM_translate
    {
        ...
        public string FTX(String[] FTXelement, int countFTX)
        {
            ...
            for (int checkFTX = 0; checkFTX < FTXelement.Count(); checkFTX++)
            {
              ...
              if(detailsFTX.Remove(0,1).ToString() == "CRE")
               {
                    finalFTX = "\"PaymentType\":" + "\"CREDIT-LINER\",";
               }
               else
               {
                    finalFTX = "\"PaymentType\":" + "\"COD\",";
               }
        ...
        public string EQD(String[] EQDelement)
        {
            ...
            if (typeEQD.Remove(0, 1).ToString() == "CN")
            {
                ...
                fianlEQD = "\"Container No\":" + "\"" + cntrNo.Remove(0, 1).ToString() + "\"," +
                  "\"ISO\":" + "\"" + cviso.iso_check(ISO.Remove(0, 1).ToString(), EQDelement[0].ToString(),"ZIM") + "\"," +
        ...
        public string MEA(String[] MEAelement)
        {
            ...
            if (firstType.Remove(0, 1).ToString() == "AAE")
            {
                ...
                if (typeMEA.Remove(0, 1).ToString() == "AAS")
                {
                    finalMEA = "\"Ventilation\":" + "\"" + weight.Remove(0, 1).ToString()+weightUOM.Remove(0, 1).Substring(0, 2).ToString()+ "\",";
                }
